...
if (class_exists('WooCommerce')) {
                ...
                <div class="single-product-slide bg-white text-center br-12">
                    <div class="product-thumb-wrap relative">
                        ...
                        <div class="quickview absolute right-0">
                            <a href="#" class="button yith-wcqv-button flex aling-center f-gap-20" data-product_id="'.esc_attr( get_the_ID() ).'" style="zoom: 1;">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" title="Quick View">
                    ...
                    if ($product->is_in_stock()) {
                        ...
                        <div class="product-stock">
                            <span class="clr-green fw-500"><i class="fa-solid fa-check"></i> In stock:</span> 
                            <span class="fw-500 clr-black-light">' .esc_html( $stock_quantity ). '</span>
                            <span class="clr-grey fw-500"> Products</sapn>
                        </div>';
                    } else {
                        $html .= '
    ...
    function kalni_mini_cart_shortcode($atts) { 
        ...
        echo '<a href="#!" class="kalni-minicart-dropdown relative" data-toggle="dropdown"> ';
            ...
            echo '</span>';
        echo '</a>';
        echo '<ul class="kalni-minicart-dropdown-menu dropdown-menu-mini-cart list-unstyled"><div class="close-cart">X</div>';
            echo '<li>';
