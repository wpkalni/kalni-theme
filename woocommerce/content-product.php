...
if( is_archive() ) : 
	$wish =  '<div class="wishlist absolute right-0 flex justify-center align-center"><a href=""> '.do_shortcode( '[ti_wishlists_addtowishlist product_id="'.esc_attr( get_the_ID() ).'" variation_id="'.esc_attr( get_the_ID() ).'"]' ).' <i class="fa-solid fa-heart"></i></div>';
