	...
	<header id="masthead" class="site-header">
		<div class="header-top bg-blue">
			<div class="container-95">
				<div class="grid grid-4 align-center g-gap-60">
		...
		<div class="header-middle">
			<div class="container-85">
				<div class="gird grid-1-5 g-gap-60 align-center">
					...
					<div class="hm-right-content">
						<div class="grid grid-2-1 align-center g-gap-10">
							<div class="header-search">
								<form action="/" class="hm-search-form flex align-center">
									<select name="allcats" id="allcats" class="select-cats fz-14 fw-500 lh-18">
									...
									<input type="search" name="s" id="s" placeholder="Search for products...">
									<input type="submit" class="bg-blue clr-white fz-14 fw-500 lh-18 text-center" value="Search">
								</form>
							</div>
							<div class="hm-right-last flex f-gap-10 align-center">
								<div class="hm-user flex align-center f-gap-5">
									<img src="/wp-content/uploads/2024/03/user.png" width="30" alt="User">
									<a href="#" class="user-link clr-black fz-12 fw-500 lh-16">Login <br> Account</a>
								</div>
								<div class="hm-heart relative">
									<img src="" alt="">
									<span class="heart-count absolute bg-red clr-white br-100">0</span>
								</div>
								<div class="hm-shuffle relative">
									<img src="" alt="">
									<span class="shuffle-count absolute bg-red clr-white br-100">0</span>
								</div>
								<div class="shoping-cart flex align-center">
									<div class="hm-cart relative">
										<img src="" alt="">
										<span class="cart-count absolute bg-red clr-white br-100">0</span>
									</div>
		...
		<div class="header-bottom">
			<div class="container-85">
				<div class="gird grid-1-3-1 g-gap-50 align-center">
					<div class="cat-menus">
						<?php
							wp_nav_menu(
								array(
					...
					<div class="hb-discount flex align-center f-gap-5">
